...
{
    /// <summary>
    /// hughes thanks to https://github.com/Jallenbah/pixelwindow
    /// he did everything!
    ...
    public class PixelWindow
    {
        ...
        /// <param name="debugInfo">Weather to show debu info in the title</param>
        public PixelWindow(uint width, uint height, uint pixelScale, string title, IPixelWindowAppManager appManager,
            float fixedTimestep = 20, uint framerateLimit = 300, bool debugInfo = true)
        {
            _width = width*pixelScale;
            _height = height* pixelScale;
            ...
            _pixelData = new PixelData(_renderWidth, _renderHeight,_pixelScale);
